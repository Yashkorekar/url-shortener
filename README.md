...
- **Swagger/OpenAPI Guide:** [SWAGGER_VALIDATION_GUIDE.md](SWAGGER_VALIDATION_GUIDE.md)
- **Render Deployment Fix:** [RENDER_API_FIX.md](RENDER_API_FIX.md)
...
**Yash Korekar**
- GitHub: [@Yashkorekar](https://github.com/Yashkorekar)
...
- Deployed on Render
- Docker image: `yashkorekar/url-shortener:latest`
